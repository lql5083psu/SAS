...
data lib1.TheSASSystem;                                                                    /* -2 pts: it is incomplete, dataset TheSASSystem is not in MyLibrary1*/   
...
data lib2.stu2;                                                                            /* -2 pts: it is incomplete, dataset stu2 is not in MyLibrary2*/   
